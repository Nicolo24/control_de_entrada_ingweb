...
Route::post('movimiento.use_token',[MovimientoController::class,'use_token'])->name('movimiento.use_token');
...
Route::post('movimientos.create_invitado',[MovimientoController::class,'create_invitado'])->name('movimiento.create_invitado');
